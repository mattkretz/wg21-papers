...
\newcommand\wgDocumentNumber{D1928R8}
...
\wgPoll{Return an unspecified value outside of the range of valid subscript
indices on \code{reduce_min_index(empty_mask)} and
\code{reduce_max_index(empty_mask)}.}
{&&&&}
