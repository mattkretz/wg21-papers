...
\begin{enumerate}
  ...
  \item \code{min_element(simd)} and
  ...
  \item \code{reduce_min_element(simd)} and
  ...
  \item \code{horizontal_min(simd)} and
  ...
  \item \code{extract_min(simd)} and
