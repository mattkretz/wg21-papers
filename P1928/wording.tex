...
namespace std {
  ...
  template <size_t Bytes>
    using @\integerfrom@ = @\seebelow@; // \expos
...
template<size_t Bytes, class... Abis>
  constexpr basic_simd_mask<Bytes, @\deducet@<@\integerfrom@<Bytes>, (basic_simd_mask<Bytes, Abis>::size() + ...)>> concat(
    const basic_simd_mask<Bytes, Abis>&... xs) noexcept;
...
public:
  ...
  static constexpr auto size = basic_simd<@\integerof@<Bytes>, Abi>::size;
