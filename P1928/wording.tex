...
\rSec1[simd.synopsis]{Header \tcode{<\wgRem{experimental/}simd>} synopsis}
...
\rSec2[simd.reductions]{\wgChange{R}{\tcode{simd} r}eductions}
...
\rSec2[simd.math]{\wgChange{M}{\tcode{simd} m}ath library}
...
\rSec2[simd.mask.ctor]{\wgChange{C}{\tcode{simd_mask} c}onstructors}
...
\rSec2[simd.mask.copy]{\wgChange{C}{\tcode{simd_mask} c}opy functions}
...
\rSec2[simd.mask.subscr]{\wgChange{S}{\tcode{simd_mask} s}ubscript operators}
...
\rSec2[simd.mask.unary]{\wgChange{U}{\tcode{simd_mask} u}nary operators}
...
\rSec2[simd.mask.binary]{\wgChange{B}{\tcode{simd_mask} b}inary operators}
...
\rSec2[simd.mask.cassign]{\wgChange{C}{\tcode{simd_mask} c}ompound assignment}
...
\rSec2[simd.mask.comparison]{\wgChange{C}{\tcode{simd_mask} c}omparisons}
...
\rSec2[simd.mask.reductions]{\wgChange{R}{\tcode{simd_mask} r}eductions}
