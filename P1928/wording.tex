...
\rSec1[basic_simd.abi]{\tcode{simd} ABI tags}
...
store \tcode{N} elements (i.e. \tcode{simd_size_v<T, \deducet<T, N>>} equals
\tcode{N}).
...
%\ref{basic_simd.overview}), where \tcode{Abi} is an ABI tag that is not a
