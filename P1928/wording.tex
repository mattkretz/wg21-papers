...
\begin{codeblock}
namespace std {
  template<class T> using @\UNSP{native-abi}@ = @\seebelow@;
  template<class T, size_t N> using @\UNSP{deduce-t}@ = @\seebelow@;
  ...
  template<class T, class Abi = @\UNSP{native-abi}@<T>> class basic_simd;
  template<class T, @\simdsizetype@ N> using simd = basic_simd<T, @\UNSP{deduce-t}@<T, N>>;

  // \ref{basic_simd.mask.class}, Class template \tcode{basic_simd_mask}
  template<size_t Bytes, class Abi = @\UNSP{native-abi}@<T>> class basic_simd_mask;
  template<class T, @\simdsizetype@ N> using fixed_size_simd_mask = basic_simd_mask<T, simd_abi::fixed_size<T, N>>;
