...
@\wgAdd{struct \mbox{\allowpartialloadstoreflag};}@                              // \expos
@\wgAdd{struct \mbox{\assumesizeflag};}@                                          // \expos
\end{codeblock}
...
namespace std {
  ...
  @\wgAdd{inline constexpr simd_flags<\mbox{\allowpartialloadstoreflag}> simd_flag_allow_partial_loadstore{};}@
  @\wgAdd{inline constexpr simd_flags<\mbox{\assumesizeflag}> simd_flag_assume_size_match{};}@
  ...
  @\wgAdd{template<class V = \mbox{\seebelow}, ranges::contiguous_range R, class... Flags>}@
    @\wgAdd{requires ranges::sized_range<R>}@
    @\wgAdd{constexpr V load_from(R\&\& r, simd_flags<Flags...> f = \{\});}@
  @\wgAdd{template<class V = \mbox{\seebelow}, ranges::contiguous_range R, class... Flags>}@
    @\wgAdd{requires ranges::sized_range<R>}@
    @\wgAdd{constexpr V load_from(R\&\& r, const typename V::mask_type\& k, simd_flags<Flags...> f = \{\});}@
  @\wgAdd{template<class V = \mbox{\seebelow}, contiguous_iterator I, class... Flags>}@
    @\wgAdd{constexpr V load_from(I first, iter_difference_t<I> n, simd_flags<Flags...> f = \{\});}@
  @\wgAdd{template<class V = \mbox{\seebelow}, contiguous_iterator I, class... Flags>}@
    @\wgAdd{constexpr V load_from(I first, iter_difference_t<I> n, const typename V::mask_type\& k,}@
                          @\wgAdd{simd_flags<Flags...> f = \{\});}@
  @\wgAdd{template<class V = \mbox{\seebelow}, contiguous_iterator I, sized_sentinel_for<I> S, class... Flags>}@
    @\wgAdd{constexpr V load_from(I first, S last, simd_flags<Flags...> f = \{\});}@
  @\wgAdd{template<class V = \mbox{\seebelow}, contiguous_iterator I, sized_sentinel_for<I> S, class... Flags>}@
    @\wgAdd{constexpr V load_from(I first, S last, const typename V::mask_type\& k,}@
                          @\wgAdd{simd_flags<Flags...> f = \{\});}@

  @\wgAdd{template<class T, class Abi, ranges::contiguous_range R, class... Flags>}@
    @\wgAdd{requires ranges::sized_range<R> and indirectly_writable<ranges::iterator_t<R>, T>}@
    @\wgAdd{constexpr void store_to(const basic_simd<T, Abi>\& v, R\&\& r, simd_flags<Flags...> f = \{\});}@
  @\wgAdd{template<class T, class Abi, ranges::contiguous_range R, class... Flags>}@
    @\wgAdd{requires ranges::sized_range<R> and indirectly_writable<ranges::iterator_t<R>, T>}@
    @\wgAdd{constexpr void store_to(const basic_simd<T, Abi>\& v, R\&\& r,}@
                            @\wgAdd{const typename basic_simd<T, Abi>::mask_type\& mask,}@
                            @\wgAdd{simd_flags<Flags...> f = \{\});}@
  @\wgAdd{template<class T, class Abi, contiguous_iterator I, class... Flags>}@
    @\wgAdd{requires indirectly_writable<I, T>}@
    @\wgAdd{constexpr void store_to(const basic_simd<T, Abi>\& v, I first, iter_difference_t<I> n,}@
                            @\wgAdd{simd_flags<Flags...> f = \{\});}@
  @\wgAdd{template<class T, class Abi, contiguous_iterator I, class... Flags>}@
    @\wgAdd{requires indirectly_writable<I, T>}@
    @\wgAdd{constexpr void store_to(const basic_simd<T, Abi>\& v, I first, iter_difference_t<I> n,}@
                            @\wgAdd{const typename basic_simd<T, Abi>::mask_type\& mask,}@
                            @\wgAdd{simd_flags<Flags...> f = \{\});}@
  @\wgAdd{template<class T, class Abi, contiguous_iterator I, sized_sentinel_for<I> S, class... Flags>}@
    @\wgAdd{requires indirectly_writable<I, T>}@
    @\wgAdd{constexpr void store_to(const basic_simd<T, Abi>\& v, I first, S last, simd_flags<Flags...> f = \{\});}@
  @\wgAdd{template<class T, class Abi, contiguous_iterator I, sized_sentinel_for<I> S, class... Flags>}@
    @\wgAdd{requires indirectly_writable<I, T>}@
    @\wgAdd{constexpr void store_to(const basic_simd<T, Abi>\& v, I first, S last,}@
                            @\wgAdd{const typename basic_simd<T, Abi>::mask_type\& mask,}@
                            @\wgAdd{simd_flags<Flags...> f = \{\});}@
...
public:
  ...
  @\wgAdd{template<class R, class... Flags>}@
    @\wgAdd{constexpr explicit basic_simd(R\&\& range, simd_flags<Flags...> = \{\});}@
  @\wgAdd{template<class R, class... Flags>}@
    @\wgAdd{constexpr basic_simd(R\&\& range, const mask_type\& mask, simd_flags<Flags...> = \{\});}@
  @\wgRem{template<class It, class... Flags>}@
    @\wgRem{constexpr explicit basic_simd(It first, simd_flags<Flags...> = \{\});}@
  @\wgRem{template<class It, class... Flags>}@
    @\wgRem{constexpr explicit basic_simd(It first, const mask_type\& mask, simd_flags<Flags...> = \{\});}@

  // \wgRem{\mbox{\ref{simd.copy}, \tcode{basic_simd}} copy functions}
  @\wgRem{template<class It, class... Flags>}@
    @\wgRem{constexpr void copy_from(It first, simd_flags<Flags...> f = \{\});}@
  @\wgRem{template<class It, class... Flags>}@
    @\wgRem{constexpr void copy_from(It first, const mask_type\& mask, simd_flags<Flags...> f = \{\});}@
  @\wgRem{template<class Out, class... Flags>}@
    @\wgRem{constexpr void copy_to(Out first, simd_flags<Flags...> f = \{\}) const;}@
  @\wgRem{template<class Out, class... Flags>}@
    @\wgRem{constexpr void copy_to(Out first, const mask_type\& mask, simd_flags<Flags...> f = \{\}) const;}@
...
@\wgAdd{template<ranges::contiguous_range R, class... Ts>}@
  @\wgAdd{basic_simd(R\&\& r, Ts...) -> \mbox{\seebelow};}@
\end{codeblock}
...
\begin{itemdecl}
@\wgAdd{template<class R, class... Flags>}@
  @\wgAdd{constexpr explicit basic_simd(R\&\& r, simd_flags<Flags...> = \{\});}@
@\wgAdd{template<class R, class... Flags>}@
  @\wgAdd{constexpr explicit basic_simd(R\&\& r, const mask_type\& mask, simd_flags<Flags...> = \{\});}@
\end{itemdecl}

\begin{itemdescr}
  \pnum
  \wgAdd{Let \code{mask} be \code{mask_type(true)} for the overload with no \code{mask} parameter.}

  \pnum\wgAdd{\constraints}
  \begin{itemize}
    \wgItemAdd[\mbox{\tcode{R}} models \mbox{\tcode{ranges::contiguous_range}} and \mbox{\tcode{ranges::sized_range}},]
    \wgItemAdd[\mbox{\tcode{ranges::size(r)}} is a constant expression, and]
    \wgItemAdd[\mbox{\tcode{ranges::size(r)}} is equal to \mbox{\tcode{size()}}.]
  \end{itemize}

  \pnum\wgAdd{\mandates}
  \begin{itemize}
    \wgItemAdd[\mbox{\tcode{ranges::range_value_t<R>}} is a vectorizable type, and]
    \wgItemAdd[if the template parameter pack \mbox{\tcode{Flags}} does not contain \mbox{\tcode{\convertflag}}, then
      the conversion from \mbox{\tcode{ranges::range_value_t<R>}} to \mbox{\tcode{value_type}} is
      value-preserving.]
  \end{itemize}

  \pnum\wgAdd{\expects}
  \begin{itemize}
    \wgItemAdd[If the template parameter pack \mbox{\tcode{Flags}} contains \mbox{\tcode{\alignedflag}},
      \mbox{\tcode{ranges::data(range)}} points to storage aligned by \mbox{\tcode{simd_alignment_v<basic_simd, ranges::range_value_t<R>>}}.]
    \wgItemAdd[If the template parameter pack \mbox{\tcode{Flags}} contains \mbox{\tcode{\overalignedflag<N>}},
      \mbox{\tcode{ranges::data(range)}} points to storage aligned by \mbox{\tcode{N}}.]
  \end{itemize}

  \pnum\wgAdd{\effects
    Initializes the $i^\text{th}$ element with \tcode{mask[$i$] ?
    static_cast<T>(ranges::data(range)[$i$]) : T()} \\\mbox{\foralli}.}
\end{itemdescr}

\begin{itemdecl}
@\wgAdd{template<ranges::contiguous_range R, class... Ts>}@
  @\wgAdd{basic_simd(R\&\& r, Ts...) -> \seebelow;}@
\end{itemdecl}
\begin{itemdescr}
  \pnum\wgAdd{\constraints
  \code{ranges::size(r)} is a constant expression.}
...
\begin{wgBAdd}
\rSec2[simd.loadstore]{\tcode{basic_simd} load and store functions}

\begin{itemdecl}
@\wgAdd{template<class V = \seebelow, ranges::contiguous_range R, class... Flags>}@
  @\wgAdd{requires ranges::sized_range<R>}@
  @\wgAdd{constexpr V load_from(R\&\& r, simd_flags<Flags...> f = \{\});}@

@\wgAdd{template<class V = \seebelow, ranges::contiguous_range R, class... Flags>}@
  @\wgAdd{requires ranges::sized_range<R>}@
  @\wgAdd{constexpr V load_from(R\&\& r, const typename V::mask_type\& mask, simd_flags<Flags...> f = \{\});}@

@\wgAdd{template<class V = \seebelow, contiguous_iterator I, class... Flags>}@
  @\wgAdd{constexpr V load_from(I first, iter_difference_t<I> n, simd_flags<Flags...> f = \{\});}@

@\wgAdd{template<class V = \seebelow, contiguous_iterator I, class... Flags>}@
  @\wgAdd{constexpr V load_from(I first, iter_difference_t<I> n, const typename V::mask_type\& mask,}@
                        @\wgAdd{simd_flags<Flags...> f = \{\});}@

@\wgAdd{template<class V = \seebelow, contiguous_iterator I, sized_sentinel_for<I> S, class... Flags>}@
  @\wgAdd{constexpr V load_from(I first, S last, simd_flags<Flags...> f = \{\});}@

@\wgAdd{template<class V = \seebelow, contiguous_iterator I, sized_sentinel_for<I> S, class... Flags>}@
  @\wgAdd{constexpr V load_from(I first, S last, const typename V::mask_type\& mask,}@
                        @\wgAdd{simd_flags<Flags...> f = \{\});}@
\end{itemdecl}
\begin{itemdescr}
  \pnum
  Let
  \begin{itemize}
    \item \code{mask} be \code{V::mask_type(true)} for overloads with no \code{mask} parameter;
    \item \tcode{R} be \tcode{span<const iter_value_t<I>>} for overloads with no template parameter
      \tcode{R};
  %Let \code{k} be \code{0} if \code{none_of(mask)} is \code{true}, \code{min(n,
      %reduce_max_index(mask) + 1} otherwise.
    \item \tcode{r} be \tcode{R(first, n)} for overloads with \tcode{n} parameter and
      \tcode{R(first, last)} for overloads with \tcode{last} parameter.
  \end{itemize}

  \pnum\mandates
  \begin{itemize}
    \item \tcode{ranges::range_value_t<R>} is a vectorizable type,
    \item the template parameter pack \code{Flags} either contains \code{\allowpartialloadstoreflag} or
      \code{\assumesizeflag},
    \item \code{same_as<remove_cvref_t<V>, V>} is \code{true},
    \item \code{V} is an enabled specialization of \code{basic_simd}, and
    \item if the template parameter pack \tcode{Flags} does not contain \tcode{\convertflag}, then
      the conversion from \tcode{ranges::range_value_t<R>} to \tcode{V::value_type} is
      value-preserving, and
    \item if the template parameter pack \code{Flags} contains \code{\assumesizeflag} and
      \code{ranges::size(r)} is a constant expression then \code{ranges::size(r)} $\ge$
      \tcode{V::size()}.
  \end{itemize}

  \pnum\expects
  \begin{itemize}
    \item \range{first}{first + n} is a valid range for overloads with \code{n} parameter.
    \item \range{first}{last} is a valid range for overloads with \code{last} parameter.
    \item If the template parameter pack \code{Flags} contains
    \code{\assumesizeflag} then \code{ranges::size(r)} $\ge$ \tcode{V::size()}
    \item If the template parameter pack \tcode{Flags} contains \tcode{\alignedflag},
      \tcode{ranges::data(r)} points to storage aligned by \tcode{simd_alignment_v<basic_simd,
      ranges::range_value_t<R>>}.
    \item If the template parameter pack \tcode{Flags} contains \tcode{\overalignedflag<N>},
      \tcode{ranges::data(r)} points to storage aligned by \tcode{N}.
  \end{itemize}

  \pnum\effects
  Initializes the $i^\text{th}$ element with \tcode{mask[$i$] \&\& $i$ < ranges::size(r) ?
  static_cast<T>(ranges::data(r)[$i$]) : T()} \foralli.
...
\begin{itemdescr}
  ...
  Let
  \begin{itemize}
    \item \code{mask} be \code{basic_simd<T, Abi>::mask_type(true)} for overloads with no
      \code{mask} parameter;
    \item \tcode{R} be \tcode{span<iter_value_t<I>>} for overloads with no template parameter
      \tcode{R};
  %Let \code{k} be \code{0} if \code{none_of(mask)} is \code{true}, \code{min(n,
      %reduce_max_index(mask) + 1} otherwise.
    \item \tcode{r} be \tcode{R(first, n)} for overloads with \tcode{n} parameter and
  ...
  \begin{itemize}
    ...
    \item the template parameter pack \code{Flags} either contains \code{\allowpartialloadstoreflag} or
      \code{\assumesizeflag},
    \item if the template parameter pack \tcode{Flags} does not contain \tcode{\convertflag}, then
      the conversion from \tcode{T} to \tcode{ranges::range_value_t<R>} is value-preserving, and
    \item if the template parameter pack \code{Flags} contains \code{\assumesizeflag} and
      \code{ranges::size(r)} is a constant expression then \code{ranges::size(r)} $\ge$
      \tcode{\simdsizev<T, Abi>}.
  \end{itemize}
  ...
  \begin{itemize}
    ...
    \item \range{first}{last} is a valid range for overloads with \code{last} parameter.
    \item If the template parameter pack \code{Flags} contains
    \code{\assumesizeflag} then \code{ranges::size(r)} $\ge$ \tcode{\simdsizev<T, Abi>}
    \item If the template parameter pack \tcode{Flags} contains \tcode{\alignedflag},
      \tcode{ranges::data(r)} points to storage aligned by \tcode{simd_alignment_v<basic_simd,
      ranges::range_value_t<R>>}.
    \item If the template parameter pack \tcode{Flags} contains \tcode{\overalignedflag<N>},
  ...
  \pnum\effects
  Evaluates \code{ranges::data(r)[$i$] = v[$i$]}, if \tcode{mask[$i$] \&\& $i$ < ranges::size(r)} is
  \code{true} \foralli.
\end{itemdescr}
\end{wgBAdd}
...
public:
  ...
  @\wgRem{template<class It, class... Flags>}@
    @\wgRem{constexpr basic_simd_mask(It first, Flags = \{\});}@
  @\wgRem{template<class It, class... Flags>}@
    @\wgRem{constexpr basic_simd_mask(It first, const basic_simd_mask\& mask, simd_flags<Flags...> = \{\});}@

  // \wgRem{\mbox{\ref{simd.mask.copy}, \tcode{basic_simd_mask}} copy functions}
  @\wgRem{template<class It, class... Flags>}@
    @\wgRem{constexpr void copy_from(It first, simd_flags<Flags...> = \{\});}@
  @\wgRem{template<class It, class... Flags>}@
    @\wgRem{constexpr void copy_from(It first, const basic_simd_mask\& mask, simd_flags<Flags...> = \{\});}@
  @\wgRem{template<class Out, class... Flags>}@
    @\wgRem{constexpr void copy_to(Out first, simd_flags<Flags...> = \{\}) const;}@
  @\wgRem{template<class Out, class... Flags>}@
    @\wgRem{constexpr void copy_to(Out first, const basic_simd_mask\& mask,}@
                           @\wgRem{simd_flags<Flags...> = \{\}) const;}@
...
\begin{itemdecl}
@\wgRem{template<class It, class... Flags>}@
  @\wgRem{constexpr basic_simd_mask(It first, simd_flags<Flags...> = \{\});}@
\end{itemdecl}
...
\begin{itemdecl}
@\wgRem{template<class Out, class... Flags>}@
  @\wgRem{constexpr void copy_to(Out first, const basic_simd_mask\& mask, simd_flags<Flags...> = \{\}) const;}@
\end{itemdecl}
