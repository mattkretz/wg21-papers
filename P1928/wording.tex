...
\item If the template parameter pack \tcode{Flags} contains the type
  identifying \tcode{simd_aligned}, \tcode{addressof(*first)} shall
  point to storage aligned by \tcode{memory_alignment_v<#1>}.
\item If the template parameter pack \tcode{Flags} contains the type
  identifying \tcode{simd_overaligned<N>}, \tcode{addressof(*first)}
...
\newcommand\conversionFlagsMandate[2]{
  ...
  identifying \tcode{simd_convert}, then the conversion from \tcode{#1} to
...
namespace std {
  ...
  // \ref{basic_simd.flags}, SIMD flags
  ...
  template<size_t... Sizes, class T, class Abi>
    constexpr tuple<basic_simd<T, simd_abi::deduce_t<T, Sizes>>...>
      split(const basic_simd<T, Abi>&) noexcept;
  template<size_t... Sizes, class T, class Abi>
    constexpr tuple<basic_simd_mask<T, simd_mask_abi::deduce_t<T, Sizes>>...>
      split(const basic_simd_mask<T, Abi>&) noexcept;
  template<class V, class Abi>
    constexpr array<V, simd_size_v<typename V::value_type, Abi> / V::size()>
      split(const basic_simd<typename V::value_type, Abi>&) noexcept;
  template<class V, class Abi>
    constexpr array<V, simd_size_v<typename V::simd_type::value_type, Abi> / V::size()>
      split(const basic_simd_mask<typename V::simd_type::value_type, Abi>&) noexcept;

  template<size_t N, class T, class A>
    constexpr array<resize_simd_t<simd_size_v<T, A> / N, basic_simd<T, A>>, N>
      split_by(const basic_simd<T, A>& x) noexcept;
  template<size_t N, class T, class A>
    constexpr array<resize_simd_t<simd_size_v<T, A> / N, basic_simd_mask<T, A>>, N>
      split_by(const basic_simd_mask<T, A>& x) noexcept;
  ...
  template<class T, class Abi, size_t N>
    constexpr resize_simd_t<simd_size_v<T, Abi> * N, basic_simd<T, Abi>>
      concat(const array<basic_simd<T, Abi>, N>& arr) noexcept;
  template<class T, class Abi, size_t N>
    constexpr resize_simd_t<simd_size_v<T, Abi> * N, basic_simd_mask<T, Abi>>
      concat(const array<basic_simd_mask<T, Abi>, N>& arr) noexcept;
...
\rSec1[basic_simd.flags]{SIMD flags}
...
\rSec2[basic_simd.flags.overview]{Class template \tcode{simd_flags} overview}

\begin{codeblock}
template <class... Flags> struct simd_flags {
  // \ref{basic_simd.flags.oper}, \tcode{simd_flags} operators
...
\rSec2[basic_simd.flags.oper]{\tcode{simd_flags} operators}
...
template<size_t... Sizes, class T, class Abi>
  constexpr tuple<basic_simd<T, simd_abi::deduce_t<T, Sizes>>...>
    split(const basic_simd<T, Abi>& x) noexcept;
template<size_t... Sizes, class T, class Abi>
  constexpr tuple<basic_simd_mask<T, simd_abi::deduce_t<T, Sizes>>...>
    split(const basic_simd_mask<T, Abi>& x) noexcept;
\end{itemdecl}

\begin{itemdescr}
  \pnum\constraints
  The sum of all values in the \tcode{Sizes} pack is equal to \tcode{simd_size_v<T, Abi>}.

  \pnum\returns
  A \tcode{tuple} of data-parallel objects with the $i^\text{th}$ \tcode{basic_simd}/\tcode{basic_simd_mask} element of the $j^\text{th}$ \tcode{tuple} element initialized to the value of the element \tcode{x} with index $i$ + sum of the first $j$ values in the \tcode{Sizes} pack.
\end{itemdescr}
...
template<class V, class Abi>
  constexpr array<V, simd_size_v<typename V::simd_type::value_type, Abi> / V::size()>
    split(const basic_simd_mask<typename V::simd_type::value_type, Abi>& x) noexcept;
\end{itemdecl}
...
\begin{itemdescr}
  ...
  \pnum\returns
  An \tcode{array} of data-parallel objects with the $i^\text{th}$ \tcode{basic_simd}/\tcode{basic_simd_mask} element of the $j^\text{th}$ \tcode{array} element initialized to the value of the element in \tcode{x} with index \tcode{$i$ + $j$ * V::size()}.
\end{itemdescr}

\begin{itemdecl}
template<size_t N, class T, class A>
  constexpr array<resize_simd<simd_size_v<T, A> / N, basic_simd<T, A>>, N>
    split_by(const basic_simd<T, A>& x) noexcept;
template<size_t N, class T, class A>
  constexpr array<resize_simd<simd_size_v<T, A> / N, basic_simd_mask<T, A>>, N>
    split_by(const basic_simd_mask<T, A>& x) noexcept;
\end{itemdecl}

\begin{itemdescr}
  \pnum\constraints
  \tcode{simd_size_v<T, A>} is an integral multiple of \tcode N.
...
\begin{itemdecl}
  template<class T, class Abi, size_t N>
    constexpr resize_simd<simd_size_v<T, Abi> * N, basic_simd<T, Abi>>
      concat(const array<basic_simd<T, Abi>, N>& arr) noexcept;
  template<class T, class Abi, size_t N>
    constexpr resize_simd<simd_size_v<T, Abi> * N, basic_simd_mask<T, Abi>>
      concat(const array<basic_simd_mask<T, Abi>, N>& arr) noexcept;
\end{itemdecl}
