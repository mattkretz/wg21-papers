...
namespace std {
  ...
  template<class T, class... Abis>
    constexpr basic_simd<T, simd_abi::deduce_t<T, (basic_simd<T, Abis>::size + ...)>>
      concat(const basic_simd<T, Abis>&...) noexcept;
  template<class T, class... Abis>
    constexpr basic_simd_mask<T, simd_abi::deduce_t<T, (basic_simd<T, Abis>::size + ...)>>
...
\begin{itemdecl}
template<class T, class... Abis>
  constexpr basic_simd<T, simd_abi::deduce_t<T, (basic_simd<T, Abis>::size + ...)>> concat(
