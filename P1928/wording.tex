...
\INFO{
  ...
  \begin{enumerate}
    ...
    \item \code{simd} implementations of math functions are allowed to have different rounding
      errors compared to the existing overloads.
...
\pnum
Each mathematical function overload for \tcode{basic_simd} applies the corresponding \tcode{<cmath>}
function element-wise. For the mathematical functions, the results per element only need to be
approximately equal to the application of the function which is overloaded for the element type.
