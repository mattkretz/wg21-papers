...
\begin{itemdescr}
  \pnum\constraints
  \begin{itemize}
    \item \tcode{iter_value_t<It>} is a vectorizable type.
    \item \tcode{is_simd_flag_type_v<Flags>} is \tcode{true}.
  \end{itemize}
...
\begin{itemdescr}
  ...
  \pnum\effects
  Copies all \tcode{simd} elements as if \tcode{first[$i$] = static_cast<iter_value_t<It>>(operator[]($i$))} \foralli.
...
\begin{itemdescr}
  ...
  \pnum\effects
  Copies the selected elements as if \tcode{first[$i$] = static_cast<iter_value_t<It>>(operator[]($i$))} \forallmaskedi.
...
\begin{itemdescr}
  ...
  Otherwise, returns the value of a selected element \tcode{x[$j$]} for which \tcode{x[$j$] <= x[$i$]} \forallmaskedi.
\end{itemdescr}
...
\begin{itemdescr}
  ...
  Otherwise, returns the value of a selected element \tcode{x.data[$j$]} for which \tcode{x.data[$j$] >= x.data[$i$]} \forallmaskedi.
\end{itemdescr}
...
\begin{itemdescr}
  \pnum\constraints
  \begin{itemize}
    \item \tcode{iter_value_t<It>} is of type \tcode{bool}.
    \item \tcode{is_simd_flag_type_v<Flags>} is \tcode{true}.
  \end{itemize}
