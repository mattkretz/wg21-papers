...
namespace std {
  ...
  template<@\simdfloatingpoint@ V>
    constexpr V acos(const V& x);
  template<@\simdfloatingpoint@ V>
    constexpr V asin(const V& x);
  template<@\simdfloatingpoint@ V>
    constexpr V atan(const V& x);
  template<typename V0, @\multisimdfloatingpoint@<V0> V1>
    constexpr common_type_t<V0, V1> atan2(const V0& y, const V1& x);
  template<@\simdfloatingpoint@ V>
    constexpr V cos(const V& x);
  template<@\simdfloatingpoint@ V>
    constexpr V sin(const V& x);
  template<@\simdfloatingpoint@ V>
    constexpr V tan(const V& x);
  template<@\simdfloatingpoint@ V>
    constexpr V acosh(const V& x);
  template<@\simdfloatingpoint@ V>
    constexpr V asinh(const V& x);
  template<@\simdfloatingpoint@ V>
    constexpr V atanh(const V& x);
  template<@\simdfloatingpoint@ V>
    constexpr V cosh(const V& x);
  template<@\simdfloatingpoint@ V>
    constexpr V sinh(const V& x);
  template<@\simdfloatingpoint@ V>
    constexpr V tanh(const V& x);
  template<@\simdfloatingpoint@ V>
    constexpr V exp(const V& x);
  template<@\simdfloatingpoint@ V>
    constexpr V exp2(const V& x);
  template<@\simdfloatingpoint@ V>
    constexpr V expm1(const V& x);
  template<@\simdfloatingpoint@ V>
    constexpr V frexp(const V& value, rebind_simd_t<int, V>* exp);
  template<@\simdfloatingpoint@ V>
    constexpr rebind_simd_t<int, V> ilogb(const V& x);
  template<@\simdfloatingpoint@ V>
    constexpr V ldexp(const V& x, const rebind_simd_t<int, V>& exp);
  template<@\simdfloatingpoint@ V>
    constexpr V log(const V& x);
  template<@\simdfloatingpoint@ V>
    constexpr V log10(const V& x);
  template<@\simdfloatingpoint@ V>
    constexpr V log1p(const V& x);
  template<@\simdfloatingpoint@ V>
    constexpr V log2(const V& x);
  template<@\simdfloatingpoint@ V>
    constexpr V logb(const V& x);
  template<@\simdfloatingpoint@ V>
    constexpr V modf(const type_identity_t<V>& value, V* iptr);
  template<@\simdfloatingpoint@ V>
    constexpr V scalbn(const V& x, const rebind_simd_t<int, V>& n);
  template<@\simdfloatingpoint@ V>
    constexpr V scalbln(const V& x, const rebind_simd_t<long int, V>& n);
  template<@\simdfloatingpoint@ V>
    constexpr V cbrt(const V& x);
  template<integral T, class Abi>
  ...
  template<@\simdfloatingpoint@ V>
    constexpr V sqrt(const V& x);
  template<@\simdfloatingpoint@ V>
    constexpr V erf(const V& x);
  template<@\simdfloatingpoint@ V>
    constexpr V erfc(const V& x);
  template<@\simdfloatingpoint@ V>
    constexpr V lgamma(const V& x);
  template<@\simdfloatingpoint@ V>
    constexpr V tgamma(const V& x);
  template<@\simdfloatingpoint@ V>
  ...
  template<@\simdfloatingpoint@ V>
    V rint(const V& x);
  template<@\simdfloatingpoint@ V>
    rebind_simd_t<long int, V> lrint(const V& x);
  template<@\simdfloatingpoint@ V>
    rebind_simd_t<long long int, V> llrint(const V& x);
  template<@\simdfloatingpoint@ V>
    constexpr V round(const V& x);
  template<@\simdfloatingpoint@ V>
    constexpr rebind_simd_t<long int, V> lround(const V& x);
  template<@\simdfloatingpoint@ V>
    constexpr rebind_simd_t<long long int, V> llround(const V& x);
  template<@\simdfloatingpoint@ V>
  ...
  template<@\simdfloatingpoint@ V>
    constexpr rebind_simd_t<int, V> fpclassify(const V& x);
  template<@\simdfloatingpoint@ V>
  ...
  template<@\simdfloatingpoint@ V>
    V comp_ellint_1(const V& k);
  template<@\simdfloatingpoint@ V>
    V comp_ellint_2(const V& k);
  template<typename V0, @\multisimdfloatingpoint@<V0> V1>
  ...
  template<@\simdfloatingpoint@ V>
    V expint(const V& x);
  template<@\simdfloatingpoint@ V>
    V hermite(const rebind_simd_t<unsigned, V>& n, const V& x);
  template<@\simdfloatingpoint@ V>
    V laguerre(const rebind_simd_t<unsigned, V>& n, const V& x);
  template<@\simdfloatingpoint@ V>
    V legendre(const rebind_simd_t<unsigned, V>& l, const V& x);
  template<@\simdfloatingpoint@ V>
    V riemann_zeta(const V& x);
  template<@\simdfloatingpoint@ V>
    V sph_bessel(const rebind_simd_t<unsigned, V>& n, const V& x);
  template<@\simdfloatingpoint@ V>
    V sph_legendre(const rebind_simd_t<unsigned, V>& l, const rebind_simd_t<unsigned, V>& m,
                   const V& theta);
  template<@\simdfloatingpoint@ V>
    V sph_neumann(const rebind_simd_t<unsigned, V>& n, const V& x);
}
\end{codeblock}
