...
\begin{itemdescr}
  ...
  \begin{wgBAdd}
    ...
    \begin{itemize}
      \wgItemAdd \wgAdd{not every possible value of \tcode{U} can be represented with type \tcode{value_type}, or}
      \wgItemAdd \wgAdd{if both \tcode{U} and \tcode{value_type} are integral, the integer conversion rank (\mbox{\ref{conv.rank}}) of \tcode{U} is greater than the integer conversion rank of \tcode{value_type}.}
    \end{itemize}
  \end{wgBAdd}
\end{itemdescr}
