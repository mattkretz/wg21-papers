...
public:
  ...
  template<@\wgChange{class U}{contiguous_iterator It}@, class Flags@\wgAdd{ = element_aligned_tag}@>
    @\wgAdd{constexpr }@simd(const @\wgChange{U* mem}{It\& first}@, Flags@\wgAdd{ = \{\}}@);

  // \ref{simd.copy}, \tcode{simd} copy functions
  template<@\wgChange{class U}{contiguous_iterator It}@, class Flags@\wgAdd{ = element_aligned_tag}@>
    @\wgAdd{constexpr void}@ copy_from(const @\wgChange{U* mem}{It\& first}@, Flags f@\wgAdd{ = \{\}}@);
  template<@\wgChange{class U}{contiguous_iterator It}@, class Flags@\wgAdd{ = element_aligned_tag}@>
    @\wgAdd{requires output_iterator<It, value_type>}@
    @\wgAdd{constexpr void}@ copy_to(@\wgChange{U* mem}{const It\& first}@, Flags f@\wgAdd{ = \{\}}@)@\wgAdd{ const}@;
...
\begin{itemdescr}
  \pnum\wgAdd{\mbox{\constraints} \tcode{iter_value_t<It>} is a vectorizable type.}
  ...
  This constructor shall not participate in overload resolution unless
  \begin{itemize}
    \item \tcode{is_simd_flag_type_v<Flags>} is \tcode{true}\wgAdd{.}\wgRem{, and}
    \wgItemRem \wgRem{\tcode{U} is a vectorizable type.}
  \end{itemize}
\end{itemdescr}
...
template<@\wgChange{class U}{contiguous_iterator It}@, class Flags@\wgAdd{ = element_aligned_tag}@>
  @\wgAdd{requires output_iterator<It, value_type>}@
  @\wgAdd{constexpr }@void copy_to(@\wgChange{U* mem}{const It\& first}@, Flags f@\wgAdd{ = \{\}}@) const;
\end{itemdecl}
...
public:
  ...
  template<class U@\wgAdd{, class UAbi}@>
    @\wgAdd{constexpr explicit(sizeof(U) != sizeof(T)) }\diffbreak{4}@simd_mask(const simd_mask<U, @\wgChange{simd_abi::fixed_size<size()>}{UAbi}@>&) noexcept;
  @\wgAdd{template<class G> constexpr explicit simd_mask(G\&\& gen) noexcept;}@
  template<@\wgAdd{contiguous_iterator It, }@class Flags@\wgAdd{ = element_aligned_tag}@>
    @\wgAdd{constexpr }@simd_mask(const @\wgChange{value_type* mem}{It\& first}@, Flags@\wgAdd{ = \{\}}@);

  // \ref{simd.mask.copy}, \wgChange{C}{\tcode{simd_mask} c}opy functions
  template<@\wgAdd{contiguous_iterator It, }@class Flags@\wgAdd{ = element_aligned_tag}@>
    @\wgAdd{constexpr}@ void copy_from(const @\wgChange{value_type* mem}{It\& first}@, Flags@\wgAdd{ = \{\}}@);
  template<@\wgAdd{contiguous_iterator It, }@class Flags@\wgAdd{ = element_aligned_tag}@>
    @\wgAdd{requires output_iterator<It, value_type>}@
    @\wgAdd{constexpr}@ void copy_to(@\wgChange{value_type* mem}{const It\& first}@, Flags@\wgAdd{ = \{\}}@)@\wgAdd{ const}@;
...
\begin{itemdescr}
  \pnum\wgAdd{\mbox{\constraints} \tcode{iter_value_t<It>} is of type \tcode{bool}.}
