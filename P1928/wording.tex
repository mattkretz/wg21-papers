...
public:
  ...
  template<class U, class Flags@\wgAdd{ = element_aligned_tag}@>@\diffbreak{4}
...
\begin{itemdescr}
  ...
  \begin{wgBAdd}
    ...
    \begin{itemize}
      \wgItemAdd \wgAdd{at least on possible value of \tcode{U} cannot be represented with type \tcode{value_type}, or}
...
public:
  ...
  template<class Flags@\wgAdd{ = element_aligned_tag}@>@\diffbreak{4}
