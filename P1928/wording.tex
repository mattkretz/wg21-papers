...
@
  ...
  template<size_t N, class T, class A>
    array<resize_simd@\wgAdd{_t}@<simd_size_v<T, A> / N, simd<T, A>>, N>
      split_by(const simd<T, A>& x) noexcept;
  template<size_t N, class T, class A>
    array<resize_simd@\wgAdd{_t}@<simd_size_v<T, A> / N, simd_mask<T, A>>, N>
  ...
  template<class T, class Abi, size_t N>
    resize_simd@\wgAdd{_t}@<simd_size_v<T, Abi> * N, simd<T, Abi>>
      concat(const array<simd<T, Abi>, N>& arr) noexcept;
  template<class T, class Abi, size_t N>
    resize_simd@\wgAdd{_t}@<simd_size_v<T, Abi> * N, simd_mask<T, Abi>>
...
public:
  ...
  template<class U@\wgAdd{, class UAbi}@> @\diffbreak{4}\wgAdd{explicit(\seebelow) constexpr }@simd(const simd<U, @\wgChange{simd_abi::fixed_size<size()>}{UAbi}@>&) noexcept;
  template<class G> explicit @\wgAdd{constexpr }@simd(G&& gen) noexcept;
  ...
  template<class U, class Flags@\wgAdd{ = element_aligned_tag}@> @\wgAdd{constexpr void }@copy_from(const U* mem, Flags f@\wgAdd{ = \{\}}@);
  template<class U, class Flags@\wgAdd{ = element_aligned_tag}@> @\wgAdd{void }@copy_to(U* mem, Flags f@\wgAdd{ = \{\}}@)@\wgAdd{ const}@;
  ...
  @\wgAdd{constexpr }@friend simd operator+(const simd&, const simd&) noexcept;
  @\wgAdd{constexpr }@friend simd operator-(const simd&, const simd&) noexcept;
  @\wgAdd{constexpr }@friend simd operator*(const simd&, const simd&) noexcept;
  @\wgAdd{constexpr }@friend simd operator/(const simd&, const simd&) noexcept;
  @\wgAdd{constexpr }@friend simd operator%(const simd&, const simd&) noexcept;
  ...
  @\wgAdd{constexpr }@friend simd operator<<(const simd&, const simd&) noexcept;
  @\wgAdd{constexpr }@friend simd operator>>(const simd&, const simd&) noexcept;
  @\wgAdd{constexpr }@friend simd operator<<(const simd&, int) noexcept;
  @\wgAdd{constexpr }@friend simd operator>>(const simd&, int) noexcept;

  // \ref{simd.cassign}, \tcode{simd} compound assignment
  @\wgAdd{constexpr }@friend simd& operator+=(simd&, const simd&) noexcept;
  @\wgAdd{constexpr }@friend simd& operator-=(simd&, const simd&) noexcept;
  @\wgAdd{constexpr }@friend simd& operator*=(simd&, const simd&) noexcept;
  @\wgAdd{constexpr }@friend simd& operator/=(simd&, const simd&) noexcept;
  @\wgAdd{constexpr }@friend simd& operator%=(simd&, const simd&) noexcept;
  ...
  @\wgAdd{constexpr }@friend simd& operator<<=(simd&, const simd&) noexcept;
  @\wgAdd{constexpr }@friend simd& operator>>=(simd&, const simd&) noexcept;
  @\wgAdd{constexpr }@friend simd& operator<<=(simd&, int) noexcept;
  @\wgAdd{constexpr }@friend simd& operator>>=(simd&, int) noexcept;

  // \ref{simd.comparison}, \tcode{simd} compare operators
  @\wgAdd{constexpr }@friend mask_type operator==(const simd&, const simd&) noexcept;
  @\wgAdd{constexpr }@friend mask_type operator!=(const simd&, const simd&) noexcept;
  @\wgAdd{constexpr }@friend mask_type operator>=(const simd&, const simd&) noexcept;
  @\wgAdd{constexpr }@friend mask_type operator<=(const simd&, const simd&) noexcept;
  @\wgAdd{constexpr }@friend mask_type operator>(const simd&, const simd&) noexcept;
...
\begin{codeblock}
explicit @\wgAdd{constexpr }@operator @\impdef@() const;
explicit @\wgAdd{constexpr }@simd(const @\impdef@& init);
\end{codeblock}
...
\begin{itemdecl}
template<class U@\wgAdd{, class UAbi}@> @\diffbreak{2}\wgAdd{explicit(\seebelow) constexpr }@simd(const simd<U, @\wgChange{simd_abi::fixed_size<size()>}{UAbi}@>& x) noexcept;
\end{itemdecl}
...
\begin{itemdecl}
template<class U, class Flags@\wgAdd{ = element_aligned_tag}@> simd(const U* mem, Flags@\wgAdd{ = \{\}}@);
\end{itemdecl}
...
public:
  ...
  template<class Flags@\wgAdd{ = element_aligned_tag}@> void copy_from(const value_type* mem, Flags@\wgAdd{ = \{\}}@);
  template<class Flags@\wgAdd{ = element_aligned_tag}@> void copy_to(value_type* mem, Flags@\wgAdd{ = \{\}}@);
