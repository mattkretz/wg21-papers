...
\recommended Implementations are encouraged to follow the C specification (specifically Annex F) for
the element-wise application of the mathematical functions.
