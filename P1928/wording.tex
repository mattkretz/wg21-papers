...
struct @\allowpartialloadstoreflag@;                              // \expos
struct @\assumesizeflag@;                                          // \expos
\end{codeblock}
...
namespace std {
  ...
  inline constexpr simd_flags<@\allowpartialloadstoreflag@> simd_flag_allow_partial_loadstore{};
  inline constexpr simd_flags<@\assumesizeflag@> simd_flag_assume_size_match{};
  ...
  template<class V = @\seebelow@, ranges::contiguous_range R, class... Flags>
    ...
    constexpr V load_from(R&& r, simd_flags<Flags...> f = {});
  template<class V = @\seebelow@, ranges::contiguous_range R, class... Flags>
    requires ranges::sized_range<R>
    constexpr V load_from(R&& r, const typename V::mask_type& k, simd_flags<Flags...> f = {});
  template<class V = @\seebelow@, contiguous_iterator I, class... Flags>
    constexpr V load_from(I first, iter_difference_t<I> n, simd_flags<Flags...> f = {});
  template<class V = @\seebelow@, contiguous_iterator I, class... Flags>
    constexpr V load_from(I first, iter_difference_t<I> n, const typename V::mask_type& k,
                          simd_flags<Flags...> f = {});
  template<class V = @\seebelow@, contiguous_iterator I, sized_sentinel_for<I> S, class... Flags>
    constexpr V load_from(I first, S last, simd_flags<Flags...> f = {});
  template<class V = @\seebelow@, contiguous_iterator I, sized_sentinel_for<I> S, class... Flags>
    constexpr V load_from(I first, S last, const typename V::mask_type& k,
                          simd_flags<Flags...> f = {});
  ...
  template<class T, class Abi, ranges::contiguous_range R, class... Flags>
    ...
    constexpr void store_to(const basic_simd<T, Abi>& v, R&& r, simd_flags<Flags...> f = {});
  template<class T, class Abi, ranges::contiguous_range R, class... Flags>
    requires ranges::sized_range<R> and indirectly_writable<ranges::iterator_t<R>, T>
    constexpr void store_to(const basic_simd<T, Abi>& v, R&& r,
  ...
  template<class T, class Abi, contiguous_iterator I, class... Flags>
    ...
    constexpr void store_to(const basic_simd<T, Abi>& v, I first, iter_difference_t<I> n,
                            simd_flags<Flags...> f = {});
  template<class T, class Abi, contiguous_iterator I, class... Flags>
    requires indirectly_writable<I, T>
    constexpr void store_to(const basic_simd<T, Abi>& v, I first, iter_difference_t<I> n,
  ...
  template<class T, class Abi, contiguous_iterator I, sized_sentinel_for<I> S, class... Flags>
    requires indirectly_writable<I, T>
    constexpr void store_to(const basic_simd<T, Abi>& v, I first, S last, simd_flags<Flags...> f = {});
  template<class T, class Abi, contiguous_iterator I, sized_sentinel_for<I> S, class... Flags>
    requires indirectly_writable<I, T>
    constexpr void store_to(const basic_simd<T, Abi>& v, I first, S last,
                            const typename basic_simd<T, Abi>::mask_type& mask,
                            simd_flags<Flags...> f = {});
...
public:
  ...
  template<class R, class... Flags>
    constexpr explicit basic_simd(R&& range, simd_flags<Flags...> = {});
  template<class R, class... Flags>
...
\begin{itemdecl}
template<class R, class... Flags>
  constexpr explicit basic_simd(R&& r, simd_flags<Flags...> = {});
template<class R, class... Flags>
  constexpr explicit basic_simd(R&& r, const mask_type& mask, simd_flags<Flags...> = {});
\end{itemdecl}
...
template<class V = @\seebelow@, ranges::contiguous_range R, class... Flags>
  requires ranges::sized_range<R>
  constexpr V load_from(R&& r, const typename V::mask_type& mask, simd_flags<Flags...> f = {});

template<class V = @\seebelow@, contiguous_iterator I, class... Flags>
  constexpr V load_from(I first, iter_difference_t<I> n, simd_flags<Flags...> f = {});

template<class V = @\seebelow@, contiguous_iterator I, class... Flags>
  constexpr V load_from(I first, iter_difference_t<I> n, const typename V::mask_type& mask,
                        simd_flags<Flags...> f = {});
...
template<class V = @\seebelow@, contiguous_iterator I, sized_sentinel_for<I> S, class... Flags>
  constexpr V load_from(I first, S last, const typename V::mask_type& mask,
                        simd_flags<Flags...> f = {});
\end{itemdecl}
\begin{itemdescr}
  \pnum
