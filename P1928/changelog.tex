...
\item Asking for reconsideration of conversion rules (\sect{sec:reconsider_conversions}).
...
\begin{revision}
\item Added \code{simd_select} discussion (\sect{sec:simd_select}).
\end{revision}
...
%\begin{revision}
%  \todo Ensure constexpr_wrapper initialization works.
