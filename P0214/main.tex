...
\begin{itemize}
  ...
  \color{black}\item[---] LEWG guidance:
    \chck Drop \code{native_handle} and add non-normative wording for supporting \code{static_cast} to implementation-defined SIMD extensions.
    ...
    Look for different names because of the unfortunate inconsistency with \std\type{atomic}.
