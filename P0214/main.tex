...
\begin{itemize}
    ...
    \chck Added SG1 poll results from JAX
  ...
  \color{black}\item[---] LEWG guidance:
    \todo Drop \code{native_handle} and add non-normative wording for supporting \code{static_cast} to implementation-defined SIMD extensions.
