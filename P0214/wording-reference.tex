...
\begin{itemdescr}
  ...
  \pnum\remarks The program is ill-formed unless \code{declval<value_type \&>() = std::forward<U>(x)} is well-formed.
\end{itemdescr}
...
\begin{itemdescr}
  ...
  \pnum\remarks The program is ill-formed unless \code{declval<value_type \&>() @= std::forward<U>(x)} (where \code @= denotes the indicated compound assignment operator) is well-formed.
\end{itemdescr}
...
\begin{itemdescr}
  ...
  \pnum\remarks The program is ill-formed unless the indicated operator can be applied to objects of type \valuetype.% i.e. break it for bool
\end{itemdescr}
