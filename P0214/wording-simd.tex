...
\pnum Each function overload produced by the above rules concurrently applies the indicated mathematical function element-wise.
...
\wgNote{
  ...
  \comment{Make this normative? And prefer implementation-defined or unspecified?}
}
