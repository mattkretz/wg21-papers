...
\begin{itemdescr}
  ...
  \wgExample{
    ...
    In this case \type{compatible<T>} aliases \type{simd128} for all arithmetic \type T, except \type{long double}.
    The implementation might therefore define \type{compatible<long double>} as an alias for \type{scalar}.
  }
