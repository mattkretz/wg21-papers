...
Guidance from SG1 at Oulu 2016:
\wgPoll{Should the interface provide a way to specify a number for over-alignment?}{0 & 0 & 0 & 0 & 0}
\wgPoll{Should loads and stores have a default load/store flag?}{0 & 0 & 0 & 0 & 0}
