...
\pnum The member type \referencetype is the same as \simd[<T, Abi>::reference], except for\comment[TODO]{probably just \valuetype}.
\comment[TODO]{add stable name reference}
...
\begin{itemdescr}
  ...
  \pnum\remarks The functions shall not participate in overload resolution unless the argument is of type \bool.
  \pnum\returns \code 0.
  \code{find_first_set} and \code{find_last_set} return 0.
\end{itemdescr}
