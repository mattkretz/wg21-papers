...
\begin{itemdescr}
  ...
  \pnum\remarks If the \type{Flags} template parameter is of type \type{flags::aligned_tag} and the pointer value is not a multiple of \code{memory_alignment<\mask>}, the behavior is undefined.
\end{itemdescr}
