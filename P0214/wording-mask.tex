...
where_expression<simd_mask<T, A>, simd<T, A>> where(const typename simd<T, A>::mask_type& k,
                                                    simd<T, A>& v) noexcept;
template <class T, class A>
const_where_expression<simd_mask<T, A>, const simd<T, A>> where(const typename simd<T, A>::mask_type& k,
                                                                const simd<T, A>& v) noexcept;
