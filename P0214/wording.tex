...
\begin{wgText}
  ...
  Each per-element operation is unsequenced with respect to one another.\comment{does this allow GPU execution?}
  ...
  \pnum
  \wgNote{The intent is to support acceleration through data-parallel where available.}\comment{query Pablo for word-smithing}
