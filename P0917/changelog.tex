...
\item Add motivation example from P2655R3 "\code{common_reference_t} of \code{reference_wrapper} should be a reference type".
  ...
  \todo https://github.com/PeterSommerlad/PSsimplesafeint

\todo List follow-up library changes:
\begin{itemize}
  \item Add hidden friend, defaulted \code{operator?:} to \code{reference_wrapper}.
\end{itemize}
\end{revision}
