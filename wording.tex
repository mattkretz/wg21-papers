...
void store(value_type *x, mask_type);
  ...
  \begin{itemdescr}
    ...
    \pnum If the largest $i$ where the second argument is \true is greater than the number of values pointed to by the first argument, the behavior is undefined.
  \end{itemdescr}
