...
template<class@\wgChange{... Ts}{ T}@>
  concept @\defexposconceptnc{math-floating-point}@ =                                      // \expos
    @\wgRem{(}\exposconceptnc{simd-floating-point}<\exposidnc{deduced-vec-t}<T\wgRem{s}>>\wgRem{ || ...)};@

@\wgRem{template<class... Ts>}@
  @\wgRem{requires \exposconceptnc{math-floating-point}<Ts...>}@
    @\wgRem{using \exposidnc{math-common-simd-t} = \seebelownc;}@                            @\wgRem{\rmfamily\itshape// \expos}@
...
\begin{itemize}
  \wgItemRem\color{black}
   \tcode{decltype(x + x)}\wgRem{, if the type of \tcode{x + x} is an enabled
...
\begin{itemdecl}
@\wgRem{template<class... Ts>}@
  @\wgRem{requires \exposconcept{math-floating-point}<Ts...>}@
    @\wgRem{using \exposid{math-common-simd-t} = \seebelow;}@
\end{itemdecl}
...
\begin{itemize}
 ...
 \wgItemRem[
   ...
   \tcode{\exposconcept{math-floating-point}<\brk{}T0>}
...
\begin{codeblock}
  ...
  @\wgAdd{template<\exposconcept{math-floating-point} V>}@
    @\wgAdd{constexpr typename \exposid{deduced-vec-t}<V>::mask_type isgreater(const \exposid{deduced-vec-t}<V>\& x, const V\& y);}@
  @\wgAdd{template<\exposconcept{math-floating-point} V>}@
    @\wgAdd{constexpr typename \exposid{deduced-vec-t}<V>::mask_type isgreater(const V\& x, const \exposid{deduced-vec-t}<V>\& y);}@
  template<@\wgChange{class V0, class V1}{\exposid{math-floating-point} V}@>
    constexpr typename @\wgChange{\exposid{math-common-simd-t}<V0, V1>}{\exposid{deduced-vec-t}<V>}@::mask_type
      isgreaterequal(const V@\wgRem{0}@& x, const V@\wgRem{1}@& y);
  @\wgAdd{template<\exposconcept{math-floating-point} V>}@
    @\wgAdd{constexpr typename \exposid{deduced-vec-t}<V>::mask_type}@
      @\wgAdd{isgreaterequal(const \exposid{deduced-vec-t}<V>\& x, const V\& y);}@
  @\wgAdd{template<\exposconcept{math-floating-point} V>}@
    @\wgAdd{constexpr typename \exposid{deduced-vec-t}<V>::mask_type}@
      @\wgAdd{isgreaterequal(const V\& x, const \exposid{deduced-vec-t}<V>\& y);}@
  template<@\wgChange{class V0, class V1}{\exposid{math-floating-point} V}@>
    constexpr typename @\wgChange{\exposid{math-common-simd-t}<V0, V1>}{\exposid{deduced-vec-t}<V>}@::mask_type
      isless(const V@\wgRem{0}@& x, const V@\wgRem{1}@& y);
  @\wgAdd{template<\exposconcept{math-floating-point} V>}@
    @\wgAdd{constexpr typename \exposid{deduced-vec-t}<V>::mask_type isless(const \exposid{deduced-vec-t}<V>\& x, const V\& y);}@
  @\wgAdd{template<\exposconcept{math-floating-point} V>}@
    @\wgAdd{constexpr typename \exposid{deduced-vec-t}<V>::mask_type isless(const V\& x, const \exposid{deduced-vec-t}<V>\& y);}@
  template<@\wgChange{class V0, class V1}{\exposid{math-floating-point} V}@>
    constexpr typename @\wgChange{\exposid{math-common-simd-t}<V0, V1>}{\exposid{deduced-vec-t}<V>}@::mask_type
      islessequal(const V@\wgRem{0}@& x, const V@\wgRem{1}@& y);
  @\wgAdd{template<\exposconcept{math-floating-point} V>}@
    @\wgAdd{constexpr typename \exposid{deduced-vec-t}<V>::mask_type}@
      @\wgAdd{islessequal(const \exposid{deduced-vec-t}<V>\& x, const V\& y);}@
  @\wgAdd{template<\exposconcept{math-floating-point} V>}@
    @\wgAdd{constexpr typename \exposid{deduced-vec-t}<V>::mask_type}@
      @\wgAdd{islessequal(const V\& x, const \exposid{deduced-vec-t}<V>\& y);}@
  template<@\wgChange{class V0, class V1}{\exposid{math-floating-point} V}@>
    constexpr typename @\wgChange{\exposid{math-common-simd-t}<V0, V1>}{\exposid{deduced-vec-t}<V>}@::mask_type
      islessgreater(const V@\wgRem{0}@& x, const V@\wgRem{1}@& y);
  @\wgAdd{template<\exposconcept{math-floating-point} V>}@
    @\wgAdd{constexpr typename \exposid{deduced-vec-t}<V>::mask_type}@
      @\wgAdd{islessgreater(const \exposid{deduced-vec-t}<V>\& x, const V\& y);}@
  @\wgAdd{template<\exposconcept{math-floating-point} V>}@
    @\wgAdd{constexpr typename \exposid{deduced-vec-t}<V>::mask_type}@
      @\wgAdd{islessgreater(const V\& x, const \exposid{deduced-vec-t}<V>\& y);}@
  template<@\wgChange{class V0, class V1}{\exposid{math-floating-point} V}@>
    constexpr typename @\wgChange{\exposid{math-common-simd-t}<V0, V1>}{\exposid{deduced-vec-t}<V>}@::mask_type
      isunordered(const V@\wgRem{0}@& x, const V@\wgRem{1}@& y);
  @\wgAdd{template<\exposconcept{math-floating-point} V>}@
    @\wgAdd{constexpr typename \exposid{deduced-vec-t}<V>::mask_type}@
      @\wgAdd{isunordered(const \exposid{deduced-vec-t}<V>\& x, const V\& y);}@
  @\wgAdd{template<\exposconcept{math-floating-point} V>}@
    @\wgAdd{constexpr typename \exposid{deduced-vec-t}<V>::mask_type}@
      @\wgAdd{isunordered(const V\& x, const \exposid{deduced-vec-t}<V>\& y);}@
  template<@\exposconcept{math-floating-point}@ V>
  ...
  @\wgAdd{template<\exposconcept{math-floating-point} V>}@
    @\wgAdd{\exposid{deduced-vec-t}<V> beta(const \exposid{deduced-vec-t}<V>\& x, const V\& y);}@
  @\wgAdd{template<\exposconcept{math-floating-point} V>}@
    @\wgAdd{\exposid{deduced-vec-t}<V> beta(const V\& x, const \exposid{deduced-vec-t}<V>\& y);}@
  ...
  @\wgAdd{template<\exposconcept{math-floating-point} V>}@
    @\wgAdd{\exposid{deduced-vec-t}<V> comp_ellint_3(const \exposid{deduced-vec-t}<V>\& x, const V\& y);}@
  @\wgAdd{template<\exposconcept{math-floating-point} V>}@
    @\wgAdd{\exposid{deduced-vec-t}<V> comp_ellint_3(const V\& x, const \exposid{deduced-vec-t}<V>\& y);}@
  template<@\wgChange{class V0, class V1}{\exposid{math-floating-point} V}@>
    @\wgChange{\exposid{math-common-simd-t}<V0, V1>}{\exposid{deduced-vec-t}<V>}@ cyl_bessel_i(const V@\wgRem{0}@& nu, const V@\wgRem{1}@& x);
  @\wgAdd{template<\exposconcept{math-floating-point} V>}@
    @\wgAdd{\exposid{deduced-vec-t}<V> cyl_bessel_i(const \exposid{deduced-vec-t}<V>\& x, const V\& y);}@
  @\wgAdd{template<\exposconcept{math-floating-point} V>}@
    @\wgAdd{\exposid{deduced-vec-t}<V> cyl_bessel_i(const V\& x, const \exposid{deduced-vec-t}<V>\& y);}@
  template<@\wgChange{class V0, class V1}{\exposid{math-floating-point} V}@>
    @\wgChange{\exposid{math-common-simd-t}<V0, V1>}{\exposid{deduced-vec-t}<V>}@ cyl_bessel_j(const V@\wgRem{0}@& nu, const V@\wgRem{1}@& x);
  @\wgAdd{template<\exposconcept{math-floating-point} V>}@
    @\wgAdd{\exposid{deduced-vec-t}<V> cyl_bessel_j(const \exposid{deduced-vec-t}<V>\& x, const V\& y);}@
  @\wgAdd{template<\exposconcept{math-floating-point} V>}@
    @\wgAdd{\exposid{deduced-vec-t}<V> cyl_bessel_j(const V\& x, const \exposid{deduced-vec-t}<V>\& y);}@
  template<@\wgChange{class V0, class V1}{\exposid{math-floating-point} V}@>
    @\wgChange{\exposid{math-common-simd-t}<V0, V1>}{\exposid{deduced-vec-t}<V>}@ cyl_bessel_k(const V@\wgRem{0}@& nu, const V@\wgRem{1}@& x);
  @\wgAdd{template<\exposconcept{math-floating-point} V>}@
    @\wgAdd{\exposid{deduced-vec-t}<V> cyl_bessel_k(const \exposid{deduced-vec-t}<V>\& x, const V\& y);}@
  @\wgAdd{template<\exposconcept{math-floating-point} V>}@
    @\wgAdd{\exposid{deduced-vec-t}<V> cyl_bessel_k(const V\& x, const \exposid{deduced-vec-t}<V>\& y);}@
  template<@\wgChange{class V0, class V1}{\exposid{math-floating-point} V}@>
    @\wgChange{\exposid{math-common-simd-t}<V0, V1>}{\exposid{deduced-vec-t}<V>}@ cyl_neumann(const V@\wgRem{0}@& nu, const V@\wgRem{1}@& x);
  @\wgAdd{template<\exposconcept{math-floating-point} V>}@
    @\wgAdd{\exposid{deduced-vec-t}<V> cyl_neumann(const \exposid{deduced-vec-t}<V>\& x, const V\& y);}@
  @\wgAdd{template<\exposconcept{math-floating-point} V>}@
    @\wgAdd{\exposid{deduced-vec-t}<V> cyl_neumann(const V\& x, const \exposid{deduced-vec-t}<V>\& y);}@
  template<@\wgChange{class V0, class V1}{\exposid{math-floating-point} V}@>
    @\wgChange{\exposid{math-common-simd-t}<V0, V1>}{\exposid{deduced-vec-t}<V>}@ ellint_1(const V@\wgRem{0}@& k, const V@\wgRem{1}@& phi);
  @\wgAdd{template<\exposconcept{math-floating-point} V>}@
    @\wgAdd{\exposid{deduced-vec-t}<V> ellint_1(const \exposid{deduced-vec-t}<V>\& x, const V\& y);}@
  @\wgAdd{template<\exposconcept{math-floating-point} V>}@
    @\wgAdd{\exposid{deduced-vec-t}<V> ellint_1(const V\& x, const \exposid{deduced-vec-t}<V>\& y);}@
  template<@\wgChange{class V0, class V1}{\exposid{math-floating-point} V}@>
    @\wgChange{\exposid{math-common-simd-t}<V0, V1>}{\exposid{deduced-vec-t}<V>}@ ellint_2(const V@\wgRem{0}@& k, const V@\wgRem{1}@& phi);
  @\wgAdd{template<\exposconcept{math-floating-point} V>}@
    @\wgAdd{\exposid{deduced-vec-t}<V> ellint_2(const \exposid{deduced-vec-t}<V>\& x, const V\& y);}@
  @\wgAdd{template<\exposconcept{math-floating-point} V>}@
    @\wgAdd{\exposid{deduced-vec-t}<V> ellint_2(const V\& x, const \exposid{deduced-vec-t}<V>\& y);}@
  template<@\wgChange{class V0, class V1, class V2}{\exposid{math-floating-point} V}@>
  ...
  @\wgAdd{template<\exposconcept{math-floating-point} V>}@
    @\wgAdd{\exposid{deduced-vec-t}<V> ellint_3(const \exposid{deduced-vec-t}<V>\& x, const V\& y, const V\& z);}@
  @\wgAdd{template<\exposconcept{math-floating-point} V>}@
    @\wgAdd{\exposid{deduced-vec-t}<V> ellint_3(const V\& x, const \exposid{deduced-vec-t}<V>\& y, const V\& z);}@
  @\wgAdd{template<\exposconcept{math-floating-point} V>}@
    @\wgAdd{\exposid{deduced-vec-t}<V> ellint_3(const V\& x, const V\& y, const \exposid{deduced-vec-t}<V>\& z);}@
  @\wgAdd{template<\exposconcept{math-floating-point} V>}@
    @\wgAdd{\exposid{deduced-vec-t}<V> ellint_3(const \exposid{deduced-vec-t}<V>\& x, const \exposid{deduced-vec-t}<V>\& y, const V\& z);}@
  @\wgAdd{template<\exposconcept{math-floating-point} V>}@
    @\wgAdd{\exposid{deduced-vec-t}<V> ellint_3(const \exposid{deduced-vec-t}<V>\& x, const V\& y, const \exposid{deduced-vec-t}<V>\& z);}@
  @\wgAdd{template<\exposconcept{math-floating-point} V>}@
    @\wgAdd{\exposid{deduced-vec-t}<V> ellint_3(const V\& x, const \exposid{deduced-vec-t}<V>\& y, const \exposid{deduced-vec-t}<V>\& z);}@
...
@\wgAdd{template<\exposconcept{math-floating-point} V>}@
  @\wgAdd{constexpr typename \exposid{deduced-vec-t}<V>::mask_type islessequal(const \exposid{deduced-vec-t}<V>\& x, const V\& y);}@
@\wgAdd{template<\exposconcept{math-floating-point} V>}@
  @\wgAdd{constexpr typename \exposid{deduced-vec-t}<V>::mask_type islessequal(const V\& x, const \exposid{deduced-vec-t}<V>\& y);}@
template<@\wgChange{class V0, class V1}{\exposid{math-floating-point} V}@>
...
@\wgAdd{template<\exposconcept{math-floating-point} V>}@
  @\wgAdd{constexpr typename \exposid{deduced-vec-t}<V>::mask_type islessgreater(const \exposid{deduced-vec-t}<V>\& x, const V\& y);}@
@\wgAdd{template<\exposconcept{math-floating-point} V>}@
  @\wgAdd{constexpr typename \exposid{deduced-vec-t}<V>::mask_type islessgreater(const V\& x, const \exposid{deduced-vec-t}<V>\& y);}@
template<@\wgChange{class V0, class V1}{\exposid{math-floating-point} V}@>
...
@\wgAdd{template<\exposconcept{math-floating-point} V>}@
  @\wgAdd{constexpr typename \exposid{deduced-vec-t}<V>::mask_type isunordered(const \exposid{deduced-vec-t}<V>\& x, const V\& y);}@
@\wgAdd{template<\exposconcept{math-floating-point} V>}@
  @\wgAdd{constexpr typename \exposid{deduced-vec-t}<V>::mask_type isunordered(const V\& x, const \exposid{deduced-vec-t}<V>\& y);}@
\end{itemdecl}
...
Ret @\placeholder{math-func-vec}@(@\wgAdd{const }@Args@\wgAdd{\&}@... args) {
  return Ret([&](@\exposid{simd-size-type}@ i) {
    return @\placeholder{math-func}(\wgChange{\exposid{make-compatible-simd-t}<Ret, Args>}{\exposid{deduced-vec-t}<V>}@(args)[i]...);
  });
}
\end{codeblock}
...
result of calling \tcode{\placeholder{math-func-vec}} with the \wgChange{arguments}{parameters} of the above
functions.
...
equal to the result of calling \tcode{\placeholder{math-func-vec}} with the \wgChange{arguments}{parameters}
...
\end{codeblock}
Let \tcode{ret} be a value of type \wgChange{\tcode{pair<Ret, rebind_t<int, Ret>}\tcode{>}}{\tcode{pair<V0, rebind_t<int, V0>}\tcode{>}}
that is the same value as the result of calling
