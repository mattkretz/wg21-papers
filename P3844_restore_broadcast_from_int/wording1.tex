...
@\wgAdd{template<class From, class To>}@
  @\wgAdd{\mbox{concept \defexposconceptnc{simd-consteval-broadcast-arg} = \libconcept{constructible_from}}<To, From>; \mbox{\rmfamily\itshape// \expos}}@
...
\wgAdd{\mandates}
\begin{itemize}
\wgItemAdd\wgAdd{\tcode{U} satisfies \tcode{\mbox{\libconcept{convertible_to}}<value_type>}, and}
\wgItemAdd\wgAdd{\tcode{is_arithmetic_v<U>} is \tcode{true},}
\end{itemize}
