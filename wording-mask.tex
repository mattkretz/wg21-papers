...
\begin{itemdescr}
  ...
  \pnum\remarks If the template parameter is of type \type{aligned_tag} and the pointer value is not a multiple of \code{memory_alignment<\mask{}>}, the behavior is undefined.
\end{itemdescr}
...
\begin{itemdescr}
  ...
  \comment{
    Is this good enough?
    The situation here is a lot simpler because no fundamental types are supported for \type U.
  }
