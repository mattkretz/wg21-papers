...
\newcommand\wgDocumentNumber{P3948R1}
...
\begin{itemize}
  ...
  \wgItemAdd[\tcode{ArgTypes} is an empty pack or
...
\subsection{Bump feature test macro}

In [version.syn] bump the \code{__cpp_lib_function_ref} version.

\subsection{Modify [utility.syn]}

In [utility.syn] remove:

\begin{wgText}[{[utility.syn]}]
\begin{codeblock}
  template<size_t I>
  ...
  @\wgRem{// \tcode{constant_arg} argument tag}@
  @\wgRem{template<auto V>}@
    @\wgRem{struct constant_arg_t \{}@
      @\wgRem{explicit constant_arg_t() = default;}@
    @\wgRem{\};}@
  @\wgRem{template<auto V> constexpr constant_arg_t<V> constant_arg\{\};}@

  // \iref{variant.monostate}, class \tcode{monostate}
  struct monostate;
\end{codeblock}
\end{wgText}

\subsection{Modify [func.wrap.ref.class]}

Modify [func.wrap.ref.class]:
\begin{wgText}[{[func.wrap.ref.class]}]
\begin{codeblock}
    // \iref{func.wrap.ref.ctor}, constructors and assignment operators
    template<class F> function_ref(F*) noexcept;
    template<class F> constexpr function_ref(F&&) noexcept;
    template<auto @\wgChange{f}{c, class F}@>
      constexpr function_ref(@\wgChange{constant_arg_t<f>}{constant_wrapper<c, F>}@) noexcept;
    template<auto @\wgChange{f}{c, class F}@, class U>
      constexpr function_ref(@\wgChange{constant_arg_t<f>}{constant_wrapper<c, F>}@, U&&) noexcept;
    template<auto @\wgChange{f}{c, class F}@, class T>
      constexpr function_ref(@\wgChange{constant_arg_t<f>}{constant_wrapper<c, F>}@, @\cv{}@ T*) noexcept;
...
Modify [func.wrap.ref.ctor]:

\begin{wgText}[{[func.wrap.ref.ctor]}]
  \setcounter{Paras}{4}
\begin{itemdecl}
...
\begin{itemdecl}
template<auto @\wgChange{f}{c, class F}@> constexpr function_ref(@\wgChange{constant_arg_t<f>}{constant_wrapper<c, F> f}@) noexcept;
\end{itemdecl}
...
\mandates
\begin{itemize}
\wgItemAdd If \tcode{is_pointer_v<F> || is_member_pointer_v<F>} is \tcode{true},
then \tcode{f\wgAdd{.value} != nullptr} is \tcode{true}\wgAdd{, and}
  \wgItemAdd[if \tcode{ArgTypes} is not an empty pack and
all types in \tcode{remove_cvref_t<ArgTypes>...} satisfy \exposconcept{constexpr-param}
then \tcode{constant_wrapper<\placeholder{INVOKE}(f.value, remove_cvref_t<ArgTypes>::value...)>} is not a
valid type].
\end{itemize}
...
\tcode{\placeholder{thunk}(\exposid{bound-entity}, \placeholder{call-args}...)}
is expression-equivalent\iref{defns.expression.equivalent} to
\tcode{invoke_r<R>(f\wgAdd{.value}, \placeholder{call-args}...)}.
\end{itemdescr}

\begin{itemdecl}
template<auto @\wgChange{f}{c, class F}@, class U>
  constexpr function_ref(@\wgChange{constant_arg_t<f>}{constant_wrapper<c, F> f}@, U&& obj) noexcept;
\end{itemdecl}

\begin{itemdescr}
\pnum
Let \tcode{T} be \tcode{remove_reference_t<U>}\wgRem{ and
...
then \tcode{f\wgAdd{.value} != nullptr} is \tcode{true}.
...
\tcode{\placeholder{thunk}(\exposid{bound-entity}, \placeholder{call-args}...)}
is expression-equivalent\iref{defns.expression.equivalent} to
\tcode{invoke_r<R>(f\wgAdd{.value}, static_cast<\cv{} T\&>(obj), \placeholder{call-args}...)}.
\end{itemdescr}

\begin{itemdecl}
template<auto @\wgChange{f}{c, class F}@, class T>
  constexpr function_ref(@\wgChange{constant_arg_t<f>}{constant_wrapper<c, F> f}@, @\cv{}@ T* obj) noexcept;
\end{itemdecl}
...
\tcode{\placeholder{thunk}(\exposid{bound-entity}, \placeholder{call-args}...)}
is expression-equivalent\iref{defns.expression.equivalent} to
\tcode{invoke_r<R>(f\wgAdd{.value}, obj, \placeholder{call-args}...)}.
\end{itemdescr}
...
\item \tcode{T} is not a specialization of \wgChange{\tcode{constant_arg_t}}{\tcode{constant_wrapper}}.
\end{itemize}
\end{itemdescr}
\end{wgText}
