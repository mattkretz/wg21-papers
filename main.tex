...
\begingroup
  ...
  \begin{itemize}
      \chck Converted \code{memory_alignment} into a non-member trait.
      \chck Extended the \code{datapar_abi} tag types with a \code{fixed_size<N>} tag to handle arbitrarily sized vectors.
