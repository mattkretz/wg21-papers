...
\begin{itemize}
  ...
  \item \code{generate}, \code{generate_n}
    ...
    Note that the generator function passed to \code{generate}/\code{generate_n} does not expect any arguments and thus has no interface for the algorithm to request a certain ABI tag from the function (template).
