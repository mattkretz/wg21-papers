...
As a consequence, the applicability of the execution policy is limited to iterators where \simd[<Iterator::value_type>] is a valid template instantiation of \simd.
