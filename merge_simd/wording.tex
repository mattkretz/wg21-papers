...
\begin{wgText}[Add a new subclause after §26.8 {[c.math]}]
...
\rSec2[simd.mask.ctor]{Constructors}
...
\rSec2[simd.mask.copy]{Copy functions}
...
\rSec2[simd.mask.subscr]{Subscript operators}
...
\rSec2[simd.mask.unary]{Unary operators}
...
\rSec2[simd.mask.binary]{Binary operators}
...
\rSec2[simd.mask.cassign]{Compound assignment}
...
\rSec2[simd.mask.comparison]{Comparisons}
...
\rSec2[simd.mask.reductions]{Reductions}
