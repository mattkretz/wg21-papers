...
\begin{itemdescr}
  ...
  \begin{itemize}
    ...
    \item \effects The assignment, compound assignment, increment, and decrement operators execute the operation on the $i$-th element in the \datapar object.
...
\begin{itemdecl}
template <class T = void, class U, class Flags = default_load_flags>
