...
\comment{Move to non-member.
  Ask LEWG about load expression vs. template param.
  Chat with Fabio: try \code{load<T, Abi = void>(const T *)} where \type T may be an arithmetic type or a \datapar.
}
\begin{itemdecl}
