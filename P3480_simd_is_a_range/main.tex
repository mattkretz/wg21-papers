...
\newcommand\wgDocumentNumber{P3480R0}
...
\newcommand\simditeratorsentinel{\UNSP{simd-iterator-sentinel}}
\newcommand\simditerator{\UNSP{simd-iterator}}
\newcommand\maskiterator{\UNSP{mask-iterator}}
...
public:
  ...
  using abi_type = Abi;
  @\wgAdd{using iterator = \mbox{\simditerator}<T, Abi>;}@
  @\wgAdd{using const_iterator = iterator;}@
...
public:
  using value_type = bool;
  using abi_type = Abi;
  @\wgAdd{using iterator = \mbox{\maskiterator}<Bytes, Abi>;}@
  @\wgAdd{using const_iterator = iterator;}@
