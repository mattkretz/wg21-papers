...
| [P0350](https://wg21.link/p0350) | [D0350](https://web-docs.gsi.de/~mkretz/D0350.pdf) | Integrating simd with parallel algorithms | LEWG, needs revision       |
...
| [P1928](https://wg21.link/p1928) | [D1928](https://web-docs.gsi.de/~mkretz/D1928.pdf) | std::simd                                 | finished, C++26            |
...
| [P3287](https://wg21.link/p3287) | [D3287](https://web-docs.gsi.de/~mkretz/D3287.pdf) | Exploration of namespaces for std::simd   | finished, C++26            |
| [P3319](https://wg21.link/p3319) | [D3319](https://web-docs.gsi.de/~mkretz/D3319.pdf) | Add an iota object for simd (and more)    | LWG                        |
| [P3430](https://wg21.link/p3430) | [D3430](https://web-docs.gsi.de/~mkretz/D3430.pdf) | simd issues: explicit, unsequenced, identity-element position, and members of disabled simd | finished, C++26            |
| [P3480](https://wg21.link/p3480) | [D3480](https://web-docs.gsi.de/~mkretz/D3480.pdf) | std::simd is a range                      | LWG, C++26                 |
| [P3488](https://wg21.link/p3488) | [D3488](https://web-docs.gsi.de/~mkretz/D3488.pdf) | Floating-Point Excess Precision           | SG6                        |
| [P3690](https://wg21.link/p3690) | [D3690](https://web-docs.gsi.de/~mkretz/D3690.pdf) | Consistency fix: Make simd reductions SIMD-generic | LWG                       |
| [P3844](https://wg21.link/p3844) | [D3844](https://web-docs.gsi.de/~mkretz/D3844.pdf) | Restore simd::vec broadcast from int      | LWG                       |
| [P3922](https://wg21.link/p3922) | [D3922](https://web-docs.gsi.de/~mkretz/D3922.pdf) | Missing deduction guide from `simd::mask` to `simd::vec`} | finished, C++26 |
| [P3932](https://wg21.link/p3932) | [D3932](https://web-docs.gsi.de/~mkretz/D3932.pdf) | Fix LWG4470: Fix integer-from in [simd] | drafting                   |
| [P3948](https://wg21.link/p3948) | [D3948](https://web-docs.gsi.de/~mkretz/D3948.pdf) | `constant_wrapper` is the only tool needed for passing constant expressions via function arguments | LEWG                       |
| [P3978](https://wg21.link/p3978) | [D3978](https://web-docs.gsi.de/~mkretz/D3978.pdf) | `constant_wrapper` should unwrap on call and subscript | drafting                   |
