...
\textcite{P0214R9} defines the trait \code{simd_abi::deduce<T, N>}, allowing users to find an “implementation-recommended” ABI tag for a given \valuetype and number of elements.
