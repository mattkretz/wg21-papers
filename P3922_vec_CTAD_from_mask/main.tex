...
\newcommand\wgDocumentNumber{P3922R0}
...
\pnumAdd
\wgAdd{\constraints
\tcode{basic_mask<Bytes, Abi>} is an enabled specialization of \tcode{basic_mask}.}

\pnumAdd
\wgAdd{\remarks
The deduced type is equivalent to the return type of \tcode{basic_mask::operator-()}.}
\end{itemdescr}
\end{wgText}
