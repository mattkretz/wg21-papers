...
\TODO{
  \todo Where does the standard allow ignoring ADL for incomplete types?
  \todo Where does the standard require instantiation for ADL?
}
...
Let's therefore consider a simple solution to make ADL avoid the above situations:\\
...
less drastic change to ADL, given an argument of pointer to \code{T}, ADL instantiates 
\code{T} and its bases but none of its template arguments.
